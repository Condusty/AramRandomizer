...
const TeamRandomizer = () => {
    ...
    return (
        <div>
            <input
                className="rounded-md block mb-2 text-sm font-medium bg-slate-800 text-gray-600 dark:text-white p-2"
                type="text"
            ...
            <div>
                <h3 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Team 1</span></h3>
                <ul>
            ...
            <div>
                <h3 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Team 2</span></h3>
                <ul>
